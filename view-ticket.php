            ...
            <form class="formValidate" id="formValidate" method="post" action="routers/add-ticket.php" novalidate="novalidate">
              ...
              <div class="row">
                <div class="input-field col s4">
                    <div class="select-wrapper initialized"><span class="caret">▼</span><input type="text" class="select-dropdown" readonly="true" data-activates="select-options-94e21b52-12ba-0db5-5af6-57084e8d1ed9" value="Choose a type"><ul id="select-options-94e21b52-12ba-0db5-5af6-57084e8d1ed9" class="dropdown-content select-dropdown "><li class="disabled"><span>Choose a type</span></li><li class=""><span>Support</span></li><li class=""><span>Payment</span></li><li class=""><span>Complaint</span></li><li class=""><span>Others</span></li></ul><select name="type" class="initialized">
